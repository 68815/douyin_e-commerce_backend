package com.example.merchandise_service.logs;
...
public class LogAspect {
     ...
     */
    @Pointcut("execution(* com.example.merchandise_service.controller..*(..))")
    public void controllerLogPointCut() {}

    /**
     * 定义切点，拦截所有service包下的所有方法
     */
    @Pointcut("execution(* com.example.merchandise_service.service..*(..))")
